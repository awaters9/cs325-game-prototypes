...
BasicGame.Game2.prototype = {
    ...
    create: function () {
        ...
        //Sets up the player
        player = this.game.add.sprite(200,50, 'hippo');
        ...
        foodGroup.children[0].position.set(832, 352);
        foodGroup.children[1].position.set(896, 352);
        foodGroup.children[2].position.set(960, 352);
        foodGroup.children[3].position.set(1088, 864);
        foodGroup.children[4].position.set(544, 768);
        foodGroup.children[5].position.set(800, 896);
        foodGroup.children[6].position.set(448, 384);
        foodGroup.children[7].position.set(160, 544);
