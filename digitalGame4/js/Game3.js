...
BasicGame.Game3.prototype = {
    ...
    create: function () {
        ...
        //Sets up the player
        player = this.game.add.sprite(10,20, 'hippo');
        ...
        foodGroup.children[0].position.set(128, 256);
        foodGroup.children[1].position.set(224, 256);
        foodGroup.children[2].position.set(320, 256);
        foodGroup.children[3].position.set(352, 256);
        foodGroup.children[4].position.set(512, 256);
        foodGroup.children[5].position.set(672, 256);
        foodGroup.children[6].position.set(960, 256);
        foodGroup.children[7].position.set(1152, 256);
